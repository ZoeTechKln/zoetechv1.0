...
public class Function2Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        canAmountTextView = (TextView) view.findViewById(R.id.Func2canAmount);
        oilAmountTextView=(TextView)view.findViewById(R.id.Func2OilAmount);
        moneyTextView = (TextView) view.findViewById(R.id.Func2Money);
        emergencyTextView = (TextView) view.findViewById(R.id.Func2emergencyOil);


        //firebaseToApp
        FirebaseDatabase database = FirebaseDatabase.getInstance();

        DatabaseReference cansAmountRef = database.getReference("Function_2/CanAmount");
        DatabaseReference oilAmountRef=database.getReference("Function_2/OilAmount");
        DatabaseReference priceRef = database.getReference("Function_2/Price");
        DatabaseReference emergencyOilRef = database.getReference("Function_2/EmergencyOil");
