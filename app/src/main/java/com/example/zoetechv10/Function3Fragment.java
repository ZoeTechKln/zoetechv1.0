...
public class Function3Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        canAmountTextView = (TextView) view.findViewById(R.id.Func3canAmount);
        oilAmountTextView=(TextView)view.findViewById(R.id.Func3OilAmount);
        moneyTextView = (TextView) view.findViewById(R.id.Func3Money);
        emergencyTextView = (TextView) view.findViewById(R.id.Func3emergencyOil);
